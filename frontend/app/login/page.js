          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-3 top-[35px] text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-450 focus:outline-none focus:text-gray-600 dark:focus:text-gray-400 cursor-pointer"
